...
const CollapsibleCard: React.FC<CollapsibleCardProps> = ({
  ...
  return (
    <div className="bg-brand-card dark:bg-[#04132B] rounded-[24px] transition-all duration-300 border border-brand-border dark:border-[#082656] relative w-full mb-0 overflow-hidden shadow-sm dark:shadow-none">
      {/* Header (Trigger) */}
      <div
