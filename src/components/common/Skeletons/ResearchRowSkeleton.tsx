...
const ResearchRowSkeleton: React.FC = () => {
  return (
    <div className="vault-research-entry animate-pulse !cursor-default !bg-white/5 border border-white/10 rounded-3xl p-8 mb-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 pb-4">
        ...
        <div className="flex flex-col gap-4 bg-white/5 rounded-2xl p-6 border border-white/5 h-[400px]">
          <div className="flex gap-4">
            <div className="w-24 h-24 bg-white/10 rounded-xl shrink-0"></div>
            <div className="flex-1 flex flex-col gap-3">
              <div className="h-5 w-3/4 bg-white/10 rounded-lg"></div>
              <div className="h-5 w-1/2 bg-white/10 rounded-lg"></div>
              <div className="h-8 w-24 bg-white/10 rounded-lg mt-2"></div>
            </div>
          </div>
        ...
        <div className="flex flex-col gap-4 bg-white/5 rounded-2xl p-6 border border-white/5 h-[400px]">
          <div className="flex gap-4">
            ...
            <div className="flex-1 flex flex-col gap-3">
              ...
              <div className="h-6 w-32 bg-white/10 rounded-lg mt-2"></div>
            </div>
          </div>
      ...
      <div className="flex items-center justify-end gap-10 mt-10 pt-8 border-t border-white/5 mr-4">
