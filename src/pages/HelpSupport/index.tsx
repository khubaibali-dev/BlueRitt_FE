...
const HelpSupportPage: React.FC = () => {
  ...
  return (
    <div className="help-page-container relative overflow-hidden">
      {/* Banner Section expanded to half screen - Adjusted for NO top space and left align */}
      <section className="tiktok-banner-wrapper relative isolate !min-h-[500px] !pt-2 sm:!pt-4">
        ...
        <div className="help-header-section !mb-0 z-10 px-6 sm:px-3 mt-6">
      ...
      <div className="px-6 sm:px-10 relative z-20 -mt-64 sm:-mt-80">
