...
const InfluencerCard: React.FC<InfluencerCardProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-[#04132B] border border-brand-border dark:border-[#082656] rounded-[24px] p-4 flex flex-col gap-8 hover:border-brand-primary dark:hover:border-blue-500/30 transition-all duration-300 group shadow-md">
