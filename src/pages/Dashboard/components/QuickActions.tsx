    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
      {[
        ...
        <div key={i} className="quick-action-card group">
          <div className="quick-action-icon-circle w-[44px] h-[44px] shrink-0 flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300">
            <action.icon size={20} />
          </div>
