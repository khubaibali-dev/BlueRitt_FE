...
const QuickActions = () => {
  ...
  const actions = [
    ...
    { icon: BarChart3, label: "MarginMax", desc: "Calculate profits", color: "text-[#F05A2B]", path: "/profit-calculator" },
    { icon: Share2, label: "SocialPulse", desc: "Track hashtags", color: "text-[#EF4444]", path: "/tiktok-trends" },
    { icon: FolderOpen, label: "ProductVault", desc: "Saved products", color: "text-[#9333EA]", path: "/products" },
  ];
