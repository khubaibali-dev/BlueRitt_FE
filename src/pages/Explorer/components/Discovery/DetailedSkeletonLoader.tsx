      ...
      <div className="flex w-full items-center justify-center gap-4 mb-4">
        <div className="text-center text-primary text-lg font-bold flex flex-col items-center ">
          ...
          >
            ...
            ></div>
            <div
              className={`absolute inset-0 flex items-end justify-end font-semibold z-10 transition-colors duration-300 ${Number(idx.valuenow) === 100 ? "text-white dark:text-white" : "text-gray-500 dark:text-gray-400"
                }`}
            >
              {Number(idx.valuenow)}%
            </div>
