          ...
          <div className="flex gap-2 p-1 bg-white/5 rounded-xl w-fit">
            {['Details', 'Reviews', 'Offers'].map((tab) => (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-[14px] text-[16px]  transition-all ${activeTab === tab
                  ? 'text-[#FFFFFF] shadow-lg font-bold'
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-8">
          ...
          {activeTab === 'Details' && (
            <>
              ...
              <div className="flex gap-2 mb-6">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-1 mt-2">
                    <h3 className="product-card-title tracking-tight max-w-[200px] sm:max-w-none">{displayProduct.title}</h3>
                    <span className="brand-tag brand-tag-default uppercase tracking-wider">Electronics</span>
                  </div>

                  <div className="flex items-end justify-between">
                    <div>
                      <div className="product-price-primary text-[18px] tracking-tight">${displayProduct.price}</div>
                      <div className="product-old-price-primary text-[13px] mt-1.5 ml-0.5">${displayProduct.oldPrice}</div>
                    </div>
                    <div className="flex flex-col items-end gap-2.5 mt-1">
                      ...
                      <span className="brand-tag brand-tag-amazon uppercase tracking-wider mb-1">Amazon Choice</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 mb-9">
                <div className="trending-badge-standard text-[13px] px-3 py-1.5">
                  <TrendingUp size={14} /> {displayProduct.growth}
                </div>
                <span className="rating-text-standard text-[13px]">{displayProduct.ratings} ratings</span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="flex flex-col gap-1.5 p-3.5 rounded-[12px] bg-[#04132B] border border-brand-inputBorder shadow-xl">
                  ...
                  <span className="metric-value">DataVision Computer Video</span>
                </div>
                <div className="flex flex-col gap-1.5 p-3.5 rounded-[12px] bg-[#04132B] border border-brand-inputBorder shadow-xl">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5 p-3.5 rounded-[12px] bg-[#04132B] border border-brand-inputBorder shadow-xl">
                    ...
                    <span className="text-[12px] text-[#FFFFFF] font-medium uppercase">US</span>
                  </div>
                  <div className="flex flex-col gap-1.5 p-3.5 rounded-[12px] bg-[#04132B] border border-brand-inputBorder shadow-xl">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5 p-3.5 rounded-[12px] bg-[#04132B] border border-brand-inputBorder shadow-xl">
                    ...
                    <span className="metric-value">9.4×3×1.2 in</span>
                  </div>
                  <div className="flex flex-col gap-1.5 p-3.5 rounded-[12px] bg-[#04132B] border border-brand-inputBorder shadow-xl">
                    <span className="metric-label">Item Weight</span>
                    <span className="metric-value">1.28 oz</span>
                  </div>
                </div>
              </div>
          ...
          {activeTab === 'Reviews' && (
            <div className="flex flex-col">
              ...
              <div className="bg-[#FF4D4D1A] border border-[#FF4D4D33] rounded-xl p-4 flex items-center gap-3 mb-6">
                ...
                <span className="text-[#FF4D4D] text-[14px] font-medium leading-tight">This product is sold by Amazon and we do not recommend purchasing it.</span>
              </div>
              ...
              <div className="bg-[#04132B] border border-brand-inputBorder rounded-[12px] p-6 mb-6 shadow-xl relative overflow-hidden">
                <div className="flex justify-between items-start mb-10 relative z-10">
                  <div>
                    <h3 className="text-[#FFFFFF]  text-[16px] mb-1">Customer Reviews</h3>
                    <p className="text-[#FFFFFF] text-[12px]">Based on verified purchases</p>
                  </div>
                  <div className="text-right">
                    <div className="flex items-baseline justify-end gap-1">
                      <span className="text-white text-[30px] font-bold">4.8</span>
                      <span className="text-[#FFFFFFB2] text-[14px]">out of 5</span>
                    </div>
                    ...
                    <p className="text-[#FFFFFFB2] text-[12px]">2326 global ratings</p>
                  </div>
                </div>
                ...
                <div className="space-y-4 relative z-10">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-4">
                      <span className="text-[#FFFFFF] text-[14px] w-11 shrink-0">{item.label}</span>
                      <div className="flex-1 h-3 bg-[#091C3D] rounded-full overflow-hidden">
                        <div
                      ...
                      <span className="text-[#6291DE] text-[14px] font-bold w-10 text-right">{item.percent}</span>
                    </div>
                  ))}
                </div>
              </div>
                  ...
                  <div key={idx} className="bg-[#04132B] border border-brand-inputBorder rounded-[12px] p-6 shadow-xl">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            <span className="text-[#FFFFFF] font-bold text-[14px]">Michael Johnson</span>
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            ...
                            <span className="text-[#FFFFFFB2] text-[12px]">• February 10, 2026</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    <h4 className="text-white font-semibold text-[16px] mb-3">Upgrading from Series 5 — Absolutely Amazing!</h4>
                    <p className="text-[#FFFFFF] text-[14px] leading-relaxed mb-4">
          ...
          {activeTab === 'Offers' && (
            <div className="flex flex-col">
              ...
              <div className="bg-[#FF4D4D1A] border border-[#FF4D4D33] rounded-xl p-4 flex items-center gap-3 mb-6">
                <AlertTriangle className="text-[#FF4D4D] shrink-0" size={20} />
                <span className="text-[#FF4D4D] text-[14px] leading-tight">This product is sold by Amazon and we do not recommend purchasing it.</span>
              </div>
              ...
              <div className="bg-[#04132B] border border-brand-inputBorder rounded-[20px] p-6 mb-6 shadow-xl">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    <h3 className="text-[#FFFFFF] font-bold text-[18px] mb-1">Available Offers</h3>
                    <p className="text-[#FFFFFFB2] text-[14px]">Compare prices from different sellers</p>
                  </div>
                  <div className="text-right">
                    <span className="text-[#FFFFFFB2] text-[12px]  tracking-widest block mb-1">Best Price</span>
                    <span className="text-[#6291DE] text-[24px] font-bold tracking-tight leading-none">$281.21</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  {[
                    ...
                    <div key={i} className="bg-[#FFFFFF0D] p-4 rounded-xl border border-white/5">
                      <span className="metric-label font-semibold mb-1">{stat.label}</span>
                      <span className="metric-value text-[14px] font-bold">{stat.value}</span>
                    </div>
                  ))}
                </div>
              </div>
                  ...
                  <div key={idx} className="bg-[#04132B] border border-brand-inputBorder rounded-[12px] p-6 shadow-xl relative overflow-hidden">
                    ...
                    <div className="grid grid-cols-2 gap-x-12 gap-y-5 mb-6">
                      <div className="flex flex-col gap-1">
                        <span className="metric-label text-[12px]">Ships From</span>
                        <span className="metric-value text-[16px] font-bold">Amazon.com</span>
                      </div>
                      <div className="flex flex-col gap-1 text-right">
                        {idx === 1 ? (
                          ...
                          <span className="metric-label text-[12px]">Price</span>
                        )}
                        <span className="text-white text-[20px] font-bold tracking-tight leading-none">$299.00</span>
                      </div>

                      <div className="flex flex-col gap-1">
                        <span className="metric-label text-[12px]">Minimum Price</span>
                        <span className="metric-value text-[16px] font-bold">$399.00</span>
                      </div>
                      <div className="flex flex-col gap-1 text-right">
                        <span className="metric-label text-[12px]">Rating</span>
                      ...
                      <div className="flex flex-col gap-1">
                        <span className="metric-label text-[12px]">Rating Info</span>
                        <span className="metric-value text-[16px] font-bold">3,639 ratings</span>
                      </div>
                      <div className="flex flex-col gap-1 text-right">
                        <span className="metric-label text-[12px]">Product Condition</span>
                        <span className="text-[#94A3B8] text-[12px] font-bold bg-white/5 px-3 py-0.5 rounded-full w-fit ml-auto">New</span>
                      </div>

                      <div className="flex flex-col gap-1">
                        <span className="metric-label text-[12px]">Seller</span>
                        <span className="metric-value text-[16px] font-bold">Amazon.com</span>
                      </div>
                      <div className="flex flex-col gap-1 text-right">
                        <span className="metric-label text-[12px]">Delivery Price</span>
                    ...
                    <div className="border-t border-white/5 pt-5 mt-2 flex items-center justify-between">
                      <div className="flex items-center gap-2.5 text-[#FFFFFFB2] text-[12px]">
                        <Store size={16} />
                        <span>Sold by Amazon.com</span>
                      </div>
                      <button className="px-6 py-2 rounded-full figma-pill-border text-white text-[14px] font-semibold hover:bg-[#2B7FFF1A] transition-all">
                        View Offer
                      </button>
                    </div>
                  </div>
